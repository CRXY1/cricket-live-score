...
const NewsCard: React.FC<NewsCardProps> = ({ article, featured = false }) => {
    return (
        <div 
            className={`bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-200 hover:shadow-xl ${
        ...
        >
            ...
            <div className="p-4">
                <h3 className={`font-bold text-gray-800 mb-2 ${featured ? 'text-2xl' : 'text-lg'}`}>
                    {article.title}
                </h3>
